...
<head>
    <meta charset="utf-8">
    <title>Parachutisme reserver </title>
...
<body>
  <?php
      include("header.php");
  ?>
  <script src="AJAX/parachutisme_ajout.js"></script>
  <main>
    <div class="">
      <h1>Reserver votre saut</h1>
      <p>Les réservations pour le parachutisme se font sur des créneaux de 2h pour permettre de s'équiper, atteindre le point de saut et have fun</p>
      <div class="Nom">
        <h2>Nom</h2>
